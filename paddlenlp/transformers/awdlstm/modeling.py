...
__all__ = ['dropout_mask', 'RNNDropout', 'WeightDropout', 'EmbeddingDropout',"AWD_LSTMPretrainedModel", 'AWD_LSTM', 
...
class AWD_LSTMPretrainedModel(PretrainedModel):
    base_model_prefix = "awd_lstm"
...
class AWD_LSTMForSequenceClassification(AWD_LSTMPretrainedModel):
    None
    
# Cell
@register_base_model
class AWD_LSTM(AWD_LSTMPretrainedModel):
...
awd_lstm_lm_config = dict(emb_sz=400, n_hid=1152, n_layers=3, pad_token=1, bidir=False, output_p=0.1,
                          hidden_p=0.15, input_p=0.25, embed_p=0.02, weight_p=0.2)
