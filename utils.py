...
__all__ = ['LinearDecoder', 'SequentialRNN', '_rm_module', 'load_keys', 'get_language_model', 'SentenceEncoder',
           'masked_concat_pool',
...
def load_keys(model, wgts):
    wgts_map = {
        '0.module.rnns.0.module.weight_hh_l0': "0.module.rnns.0.weight_hh_l0_raw",
        '0.module.rnns.1.module.weight_hh_l0': "0.module.rnns.1.weight_hh_l0_raw",
        '0.module.rnns.2.module.weight_hh_l0': "0.module.rnns.2.weight_hh_l0_raw",
        "0.rnns.0.module.weight_hh_l0":  "0.rnns.0.weight_hh_l0_raw",
        "0.rnns.1.module.weight_hh_l0":  "0.rnns.1.weight_hh_l0_raw",
        "0.rnns.2.module.weight_hh_l0":  "0.rnns.2.weight_hh_l0_raw",
    }
    for k in wgts_map:
        if wgts_map[k] not in wgts:
            print(wgts_map[k])
            continue

        wgts[k] = wgts[wgts_map[k]]
        del wgts[wgts_map[k]]
    sd = wgts.copy()
